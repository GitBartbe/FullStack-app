            ...
            <li>
              ...
              >
                <span class="flex items-center space-x-3 truncate">
                  <span
                    class="h-2.5 w-2.5 flex-shrink-0 rounded-full bg-pink-600"
                    aria-hidden="true"
                  ></span>
...
import { FTECH_NOTES } from '@/store/notes/actionTypes'
import { LOG_OUT } from '@/store/auth/actionTypes'
export default {
  computed: {
  ...
  methods: {
    ...mapActions([FTECH_NOTES, LOG_OUT]),
    logOut() {
      this.LOG_OUT()
